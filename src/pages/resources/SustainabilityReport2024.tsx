...
export default function SustainabilityReport2024() {
  const relatedArticles = ARTICLES.filter(a => a.slug !== 'sustainability-report-2024').slice(0, 3);

  return (
    <>
      <Helmet>
        <title>2024 Sustainability Report | Grunge Pallets & Recycling</title>
        <meta name="description" content="Explore our 2024 environmental impact report. See how Grunge Pallets is leading sustainable pallet solutions in Metro Atlanta." />
      </Helmet>
      <MainLayout>
        <ArticleLayout
